        ...
        stage ('compilation') {
            steps {
                parallel (
                    ...
                    "rhel"   		: { sh 'cd probe && bash -x ../sysdig/scripts/build-probe-binaries sysdig-probe 0.22.0 stable RHEL' },
                    "fedora" 		: { sh 'cd probe && bash -x ../sysdig/scripts/build-probe-binaries sysdig-probe 0.22.0 stable Fedora' },
                    ...
                    "oracle_rhck" 	: { sh 'cd probe && bash -x ../sysdig/scripts/build-probe-binaries sysdig-probe 0.22.0 stable Oracle_RHCK' },
                    ...
                    "amazon_linux" 	: { sh 'cd probe && bash -x ../sysdig/scripts/build-probe-binaries sysdig-probe 0.22.0 stable AmazonLinux' },
                    "amazon_linux2" 	: { sh 'cd probe && bash -x ../sysdig/scripts/build-probe-binaries sysdig-probe 0.22.0 stable AmazonLinux2' },
                )
            }
        }
