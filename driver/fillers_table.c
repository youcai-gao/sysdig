...
const struct ppm_event_entry g_ppm_events[PPM_EVENT_MAX] = {
	...
	[PPME_SOCKET_SETSOCKOPT_E] = {FILLER_REF(sys_setsockopt_e)},
	[PPME_SOCKET_SETSOCKOPT_X] = {FILLER_REF(sys_single_x)},
	[PPME_SOCKET_GETSOCKOPT_E] = {FILLER_REF(sys_getsockopt_e)},
